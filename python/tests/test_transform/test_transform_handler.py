from src.transform.transform_handler import lambda_handler
import pytest
import boto3
...
def event():
    return {"tables" : ["address", "counterparty"],
                "from_time" : "2025-06-02 11:30:55.00",
                 "to_time" : "2025-06-02 11:31:55.00", "processed_data_bucket" : "tt-processed-data"
                 }
